...
public:
    ...
    /// </summary>
    mlir::LogicalResult ConvertField(EsiCapnpLocation loc, StructSchema::Field field, FieldInfo& fi)
    {
        auto fieldLoc = loc.AppendField(field.getProto().getName());
        return ConvertType(fieldLoc, field.getType(), field.getProto().getName().cStr(), fi);
    }
        ...
        FieldInfo& fi)
    {
        switch (type.which()) {
            ...
            case ::capnp::schema::Type::Which::BOOL:
                fi = FieldInfo(name, mlir::IntegerType::get(1, mlir::IntegerType::SignednessSemantics::Signless, ctxt));
                break;
            case ::capnp::schema::Type::Which::INT8:
                fi = FieldInfo(name, mlir::IntegerType::get(8, mlir::IntegerType::SignednessSemantics::Signed, ctxt));
                break;
            case ::capnp::schema::Type::Which::INT16:
                fi = FieldInfo(name, mlir::IntegerType::get(16, mlir::IntegerType::SignednessSemantics::Signed, ctxt));
                break;
            case ::capnp::schema::Type::Which::INT32:
                fi = FieldInfo(name, mlir::IntegerType::get(32, mlir::IntegerType::SignednessSemantics::Signed, ctxt));
                break;
            case ::capnp::schema::Type::Which::INT64:
                fi = FieldInfo(name, mlir::IntegerType::get(64, mlir::IntegerType::SignednessSemantics::Signed, ctxt));
                break;
            case ::capnp::schema::Type::Which::UINT8:
                fi = FieldInfo(name, mlir::IntegerType::get(8, mlir::IntegerType::SignednessSemantics::Unsigned, ctxt));
                break;
            case ::capnp::schema::Type::Which::UINT16:
                fi = FieldInfo(name, mlir::IntegerType::get(16, mlir::IntegerType::SignednessSemantics::Unsigned, ctxt));
                break;
            case ::capnp::schema::Type::Which::UINT32:
                fi = FieldInfo(name, mlir::IntegerType::get(32, mlir::IntegerType::SignednessSemantics::Unsigned, ctxt));
                break;
            case ::capnp::schema::Type::Which::UINT64:
                fi = FieldInfo(name, mlir::IntegerType::get(64, mlir::IntegerType::SignednessSemantics::Unsigned, ctxt));
                break;
            case ::capnp::schema::Type::Which::FLOAT32:
                fi = FieldInfo(name, mlir::esi::FloatingPointType::get(ctxt, true, 8, 23));
                break;
            case ::capnp::schema::Type::Which::FLOAT64:
                fi = FieldInfo(name, mlir::esi::FloatingPointType::get(ctxt, true, 11, 52));
                break;
            case ::capnp::schema::Type::Which::TEXT:
            case ::capnp::schema::Type::Which::DATA:
                fi = FieldInfo(name, mlir::esi::ListType::get(ctxt, mlir::IntegerType::get(8, mlir::IntegerType::SignednessSemantics::Signless, ctxt)));
                break;
